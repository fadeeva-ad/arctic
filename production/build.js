...
/******/ 	__webpack_require__.p = "production/";
/******/
/******/
...
/***/ "./dev/js/custom-scripts sync recursive \\.js$":
/*!******************************************!*\
  !*** ./dev/js/custom-scripts sync \.js$ ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./js-tricks.js": "./dev/js/custom-scripts/js-tricks.js",
	"./sliders.js": "./dev/js/custom-scripts/sliders.js"
};
...
webpackContext.id = "./dev/js/custom-scripts sync recursive \\.js$";

/***/ }),

/***/ "./dev/js/custom-scripts/js-tricks.js":
/*!********************************************!*\
  !*** ./dev/js/custom-scripts/js-tricks.js ***!
  \********************************************/
/*! no static exports found */
...
var _mainJs = __webpack_require__(/*! ../mainJs.js */ "./dev/js/mainJs.js");

_mainJs.arctic.jsTricks = {
    ...
    init: function init() {
        _mainJs.arctic.jsTricks.remove();
    }
};

function tabs() {
    $('[data-tab]').each(function () {
        // выбираем кнопки на странице и проходимся по каждой

        $(this).click(function (e) {
            // прослушивваем "клик" по кнопке
            e.preventDefault();

            var buttonClass = $(this).attr('class').split(' ')[0]; // получаем класс кнопки       

            var target = $(this).attr('data-tab'); // находим "цель" кнопки

            var targetClass = $('[data-index="' + target + '"]').attr('class').split(' ')[0]; // получаем класс "цели"
...
$(function () {
    _mainJs.arctic.jsTricks.init();
    tabs();
});

/***/ }),

/***/ "./dev/js/custom-scripts/sliders.js":
/*!******************************************!*\
  !*** ./dev/js/custom-scripts/sliders.js ***!
  \******************************************/
/*! no static exports found */
...
_mainJs.arctic.sliders = {
    mainSlider: function mainSlider() {
        var mainSlider = new _swiper2.default(".main-slider .swiper-container", {
            loop: true,
            navigation: {
    ...
    archiveSlider: function archiveSlider() {
        var archiveSlider = new _swiper2.default(".block-11_slider", {
            loop: true,
            slidesPerView: 1,
            navigation: {
                prevEl: ".main-slider__arrow_prev",
    ...
    init: function init() {
        _mainJs.arctic.sliders.mainSlider();
        _mainJs.arctic.sliders.archiveSlider();
    }

};

$(function () {
    _mainJs.arctic.sliders.init();
});

/***/ }),

/***/ "./dev/js/js-libs sync recursive \\.js$":
/*!***********************************!*\
  !*** ./dev/js/js-libs sync \.js$ ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./fancybox.js": "./dev/js/js-libs/fancybox.js",
	"./filter.js": "./dev/js/js-libs/filter.js",
	"./flexMenu.js": "./dev/js/js-libs/flexMenu.js",
	"./pasteSVG.js": "./dev/js/js-libs/pasteSVG.js"
};
...
webpackContext.resolve = webpackContextResolve;
module.exports = webpackContext;
webpackContext.id = "./dev/js/js-libs sync recursive \\.js$";

/***/ }),

/***/ "./dev/js/js-libs/fancybox.js":
/*!************************************!*\
  !*** ./dev/js/js-libs/fancybox.js ***!
  \************************************/
/*! no static exports found */
...
var filterTabs = function filterTabs(number) {
...
//     $(".header__list").flexMenu();
// });

/***/ }),

/***/ "./dev/js/js-libs/pasteSVG.js":
/*!************************************!*\
  !*** ./dev/js/js-libs/pasteSVG.js ***!
  \************************************/
/*! no static exports found */
...
var arctic = exports.arctic = {};

function requireAll(r) {
  r.keys().forEach(r);
}
requireAll(__webpack_require__("./dev/js/js-libs sync recursive \\.js$"));
requireAll(__webpack_require__("./dev/js/custom-scripts sync recursive \\.js$"));
...
/***/ 0:
/*!**********************************************************!*\
  !*** multi ./dev/scss/mainStyle.scss ./dev/js/mainJS.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./dev/scss/mainStyle.scss */"./dev/scss/mainStyle.scss");
module.exports = __webpack_require__(/*! ./dev/js/mainJS.js */"./dev/js/mainJS.js");
